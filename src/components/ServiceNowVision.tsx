...
export const ServiceNowVision: FC<{
              ...
              <Fragment>
                ...
                >
                  <img
                    ...
                    className="w-auto h-full rounded-3xl object-cover group-hover:brightness-50 transition-all duration-300"
                    alt=""
                  />
                    ...
                    <div className="max-w-7xl w-full aspect-video">
                      <iframe
                        ...
                        src={`https://www.youtube-nocookie.com/embed/${
                          youtube_video_id ? youtube_video_id : "YdFVSwmsnBU"
