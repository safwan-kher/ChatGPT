...
export const EducateTalentAcceleratorSkills: FC<{
      ...
      >
        ...
        <ul className="grid grid-cols-2 lg:grid-cols-3 gap-x-[23px] gap-y-[21px] list-none mt-6 text-sm">
          {talent_accelerator_skills_skills
            ...
            .concat([
              <li
                className={`flex items-center justify-center text-center rounded h-[40px] ${style.fontTitle1} bg-educateAccent text-white`}
                key="special"
              >
                <span
                  className={`${
