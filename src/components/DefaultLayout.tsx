...
const DefaultLayout: FC<{ pageProps: any }> = ({ children, pageProps }) => {
  ...
  useEffect(() => {
    ...
    // TODO: Fix memory leak. cancel all subscriptions and asynchronous tasks in a useEffect cleanup function
  }, []);
  ...
  return (
    <div className={"app"}>
      ...
      />
      <Header
        alternativeLanguagePageSlug={pageProps.alternativeLanguagePageSlug}
      />
...
const getDefaultLayout: IGetLayout = (page: ReactElement) => {
  return <DefaultLayout pageProps={page.props}>{page}</DefaultLayout>;
};
