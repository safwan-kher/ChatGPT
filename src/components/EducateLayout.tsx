...
const EducateLayout: FC<{ pageProps: any }> = ({ children, pageProps }) => {
  ...
  return (
    <>
      ...
      <footer className="footer-educate full-width-outer" role="complementary">
        <Link
...
const getEducateLayout: IGetLayout = (page: ReactElement) => {
  return <EducateLayout pageProps={page.props}>{page}</EducateLayout>;
};

export { getEducateLayout };
