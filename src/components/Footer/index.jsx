...
export default function Footer() {
  ...
  const FooterLinks = [];
  const availableLanguages = Object.keys(FooterItems);
        ...
        if (
          ...
          items.push(
            <Link
              ...
              key={page.slug}
              href={`/${page.slug}`}
              passHref={page.openInNewTab ? true : false}
  ...
  const isLandingPage = utils.isLandingPage(true, localizedPath);
  ...
  if (isUltraLandingPage) {
    return (
      <footer className="footer-alt full-width-outer" role="complementary">
        ...
        <p>
          Copyright &copy; {currentYear} StartSteps Digital Education GmbH. All
          rights reserved.
        </p>
