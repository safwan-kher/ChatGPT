...
> = ({ content }) => {
  ...
  const isReferredByBootcamp =
    typeof cookies.ref === "string"
      ? cookies.ref.toLowerCase().startsWith("partner-recommendation-")
      : false;
  return (
      ...
      <UltraHeader
        ...
        form={
          <Form
            ...
            stageId={isReferredByBootcamp ? 96 : 1}
            leadSource={
              isReferredByBootcamp ? "Partner Referral" : "Landing Page 2.0"
            }
